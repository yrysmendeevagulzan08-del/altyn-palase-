        ...
        <div className="bg-[#161618] border border-neutral-800/80 p-6 rounded-lg relative overflow-hidden">
          ...
          <div className="mt-6 space-y-4 pt-6 border-t border-neutral-800/80 text-xs font-mono">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-3 text-neutral-300 border-t border-neutral-850 pt-3 hover:text-[#0088cc] transition-colors group"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 text-[#0088cc] shrink-0 transition-transform group-hover:scale-110">
              ...
              <span>Telegram Chat: <strong className="text-[#0088cc] font-bold">@altynpalace_bot</strong></span>
            </a>
