    ...
    <nav className="sticky top-0 z-50 bg-[#0a0a0b]/95 backdrop-blur-md border-b border-gold/15 text-neutral-100 shadow-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* Telegram Quick Action Button */}
            <a
              href={telegramUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center space-x-1.5 px-3 py-2 bg-[#0088cc] hover:bg-[#007bbd] text-neutral-950 hover:text-white text-xs font-mono font-bold uppercase rounded-sm transition-all duration-300 shadow-[0_2px_8px_rgba(0,136,204,0.2)]"
              id="nav-telegram-btn"
              title={currentLang === 'KG' ? "Телеграмдан жазуу" : currentLang === 'RU' ? "Написать в Телеграм" : "Send Telegram message"}
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#0a0a0b]/98 border-b border-neutral-800 py-4 px-4 space-y-1">
          ...
          <div className="pt-4 border-t border-neutral-900 grid grid-cols-3 gap-2">
            <a
              href={whatsAppUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center space-x-1 px-2 py-3 bg-[#25D366] hover:bg-[#20ba56] text-neutral-950 hover:text-white text-xs font-bold tracking-tight uppercase rounded-sm transition-all text-center"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center space-x-1 px-2 py-3 bg-[#0088cc] hover:bg-[#007bbd] text-neutral-950 hover:text-white text-xs font-bold tracking-tight uppercase rounded-sm transition-all text-center"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4.5 w-4.5 shrink-0">
                <path d="M11.99 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.62 0 11.99 0zM17.5 8.95l-1.72 8.12c-.13.58-.48.72-.96.44l-2.62-1.93-1.26 1.22c-.14.14-.26.26-.53.26l.19-2.66 4.84-4.37c.21-.19-.05-.29-.33-.11L9.13 13.04l-2.58-.81c-.56-.18-.57-.56.12-.83l10.08-3.89c.47-.17.88.11.75.71z"/>
              </svg>
            ...
            <button
              onClick={() => handleTabClick('rooms')}
              className="w-full text-center px-2 py-3 bg-gold hover:bg-gold-550 text-neutral-950 text-xs font-bold tracking-tight uppercase rounded-sm transition-all"
            >
              {t('btnBookNow')}
            </button>
          </div>
